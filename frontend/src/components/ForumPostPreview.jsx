...
const ForumPostPreview = ({ title, content, score, featuredComment ,id}) => {
      ...
      {featuredComment ? (
        ...
        <div className="grid grid-cols-[2fr_1fr]">
          ...
          <div className="grid grid-rows-2 justify-items-center items-center p-10">
            <button onClick={()=>{navigate(`/forum/${id}`)}} className="px-4 py-2 bg-[#0B0B66] text-white w-fit h-fit font-medium hover:outline hover:outline-blue-300 transition-colors">
              Przejdź do tematu
            </button>
